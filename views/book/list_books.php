				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><img src="public/image/<?php echo $value['picture'] ?>" alt="" style="height: 70px;"></td>
							<td><a href="?controller=book&action=delete&id=<?php echo $value['bookID']; ?>">
									<button type="button" class="btn btn-info">Delete</button>
								</a></td>
								<td><a href="?controller=book&action=edit&id=<?php echo $value['bookID']; ?>">
						...
						<td><a href="?controller=book&action=add_new"><button  type="button"  class="btn btn-info">ADD</button></a></td>
					</tr>
					</tbody>
				</table>
			</div>
