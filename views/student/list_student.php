				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="?controller=student&action=delete&id=<?php echo $value['cardID']; ?>">
									<button type="button" class="btn btn-info">Delete</button>
								</a></td>
								<td><a href="?controller=student&action=edit&id=<?php echo $value['cardID']; ?>">
						...
						<td><a href="?controller=student&action=add_new"><button  type="button"  class="btn btn-info">ADD</button></a></td>
					</tr>
					</tbody>
				</table>
			</div>
