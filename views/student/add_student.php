	...
	<body>
		...
		<form action="" method="POST" role="form" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="" placeholder="Input field" name="cardID">
			...
			<button name="action" value="save_student" type="submit" class="btn btn-primary">ADD STUDENT</button>
		</form>
